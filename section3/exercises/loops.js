...
// EXPLAIN: The output will be 0123. The loop is being repeated until i=3, when the loop stops.
//the output i is logged each time a loop is completed, and increases in value.
